...
* [Hermit](https://github.com/RadicalZephyr/hermit) is a tool that simplifies having multiple separate configuration setups that you want to switch between (like personal and work configurations). It also helps handle not committing private information (like API keys) to your git repository.
